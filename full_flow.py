...
if make_exclusive_cuts:
    ...
    if make_ex_cut_exp:
        ...
        if plot_initial_exp_distros:
            ...
            histo_plotting.make_all_histos(df_exp_epgg,datatype="exp",hists_2d=False,hists_1d=True,
        ...
        if plot_final_exp_distros:
            ...
            histo_plotting.make_all_histos(df_dvpip_exp,datatype="exp",hists_2d=False,hists_1d=True,
                    first_label='exp',hists_overlap=False,saveplots=True,output_dir = title_dir)
    ...
    if make_ex_cut_rec:
        ...
        if plot_initial_rec_distros:
            ...
            histo_plotting.make_all_histos(df_rec_epgg,datatype="rec",hists_2d=False,hists_1d=True,
        ...
        if plot_final_rec_distros:
            ...
            histo_plotting.make_all_histos(df_dvpip_rec,datatype="rec",hists_2d=False,hists_1d=True,
                    first_label='rec',hists_overlap=False,saveplots=True,output_dir = title_dir)
    ...
    if make_ex_cut_gen:
        ...
        if plot_initial_gen_distros:
            ...
            histo_plotting.make_all_histos(df_gen_epgg,datatype="Gen",hists_2d=False,hists_1d=True,
        ...
        if plot_final_gen_distros:
            ...
            histo_plotting.make_all_histos(df_dvpip_gen,datatype="Gen",hists_2d=False,hists_1d=True,
                    first_label='gen',hists_overlap=False,saveplots=True,output_dir = title_dir)
